        ...
        with open(DATA_FILE, 'r', encoding='utf-8', newline='') as f:
            ...
            for row in reader:
                ...
                try:
                    ...
                    if role == 'Admin':
                        user = Admin(user_id, username, password_hash, is_active=is_active_bool)
                        ...
                        user = User(user_id, username, password_hash, role, is_active_bool)
...
def save_users():
    ...
    try:
        with open(DATA_FILE, 'w', encoding='utf-8', newline='') as f:
            ...
            # Aktualizujemy workers.csv dla Workerów, HR i Managerów
